...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/mp5/error/style-exception.css">
    </head>
    <body>
        <div class="main">          
            <div class="logo_bar">
            ...
            <div class="error_message">
                <div class="error">
                    <h1>
                        ...
                        It seems that you typed the wrong username and/or password
                    </h1>
                    <a href="/mp5/registeredUser/login.jsp">
